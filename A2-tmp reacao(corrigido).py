...
class SimuladorTempoReacao:
    def __init__(self):
        ...
        self.label_instrucao = tk.Label(self.janela, text="""Clique no botão quando a cor mudar 
        de verde para vermelho""") #especifiquei as cores que mudam
    ...
    def iniciar_simulacao(self):
        ...
        cor_aleatoria = random.choice(["green"]) #tirei o azul e o vermelho, deixando so o verde
