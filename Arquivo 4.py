...
botao_potencia.grid(column=5,row=2)

botao_raiz=tk.Button(janela, text="√",command=lambda:raiz(),width=13, height=4,font=("Arial",12))
botao_raiz.grid(column=5,row=3)

botao_umdivx=tk.Button(janela, text="1/x",command=lambda:inverse(),width=13, height=4,font=("Arial",12))
